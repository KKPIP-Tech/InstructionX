...
纯数据模块（catalog/loader/fallback/settings_store/plugin_registry/ixplugin_i18n）
直接导出；LanguageManager 依赖 PySide6，按 PEP-562 惰性导出，
...
from .ixplugin_i18n import resolve_i18n_field
