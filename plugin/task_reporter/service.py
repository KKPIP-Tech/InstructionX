...
class ReporterService:
    ...
    def subscribe_to_task_manager(self, task_manager_id: str) -> bool:
        """
        订阅任务管理器的数据变更
        
        Args:
            task_manager_id: 任务管理器插件ID
    ...
    def get_statistics_report(self, task_manager_id: str) -> Dict[str, Any]:
        """
        获取统计报告
    ...
    def generate_report(self, task_manager_id: str, format: str = "json") -> str:
        """
        生成完整报告
        ...
        """
        # 获取统计数据
        stats_report = self.get_statistics_report(task_manager_id)
...
<body>
    ...
    <p><strong>任务管理器ID:</strong> {task_manager_id}</p>
