...
class TaskReporterPlugin(IPlugin):
    ...
    def get_widget(self, parent=None, data_provider=None) -> QWidget:
        ...
        self.manager_id_input.addItem("task-manager-default")
    ...
    def _edit_manager_id(self):
        ...
        if current_id == "双击修改ID...":
            current_id = "task-manager-default"
    ...
    def _subscribe(self, service):
        ...
        if manager_id == "双击修改ID...":
            QMessageBox.warning(None, "警告", "请先设置任务管理器ID")
            return
        ...
        if service.subscribe_to_task_manager(manager_id):
            ...
            QMessageBox.warning(None, "失败", "订阅失败")
    ...
    def _refresh_stats(self, service):
        ...
        manager_id = self.manager_id_input.item(0).text()
        if manager_id == "双击修改ID...":
            manager_id = "task-manager-default"
